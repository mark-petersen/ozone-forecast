...
df2 = pd.read_csv('allSummer_delhi.csv')
...
plt.grid(b= True)
plt.title("Summer Linear Regression - Correlation: %s" %predR2ln, size = 20)
plt.savefig('figs/Summer Linear Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer KNN Regression - Correlation: %s" %predR2kn, size = 20)
plt.savefig('figs/Summer KNN Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer SVM Regression - Correlation: %s" %predR2svr, size = 20)
plt.savefig('figs/Summer SVM Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer Random Forests Regression - Correlation: %s" %predR2rf, size = 20)
plt.savefig('figs/Summer Random Forests Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer Decision Tree Regression - Correlation: %s" %predR2dt, size = 20)
plt.savefig('figs/Summer Decision Tree Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer AdaBoost Regression - Correlation: %s" %predR2ada, size = 20)
plt.savefig('figs/Summer AdaBoost Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Summer XGBoost Regression - Correlation: %s" %predR2xgb, size = 20)
plt.savefig('figs/Summer XGBoost Regression.png')
plt.show()
...
df3.hist(column='Summer Percent Different', grid=True, bins=50, range=[-100, 100])#xlabelsize=None, ylabelsize=None, figsize=None, 
