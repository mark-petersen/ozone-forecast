...
df2 = pd.read_csv('allFall_delhi.csv')
...
plt.grid(b= True)
plt.title("Fall Linear Regression - Correlation: %s" %predR2ln, size = 20)
plt.savefig('figs/Fall Linear Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall KNN Regression - Correlation: %s" %predR2kn, size = 20)
plt.savefig('figs/Fall KNN Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall SVM Regression - Correlation: %s" %predR2svr, size = 20)
plt.savefig('figs/Fall SVM Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall Random Forests Regression - Correlation: %s" %predR2rf, size = 20)
plt.savefig('figs/Fall Random Forests Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall Decision Tree Regression - Correlation: %s" %predR2dt, size = 20)
plt.savefig('figs/Fall Decision Tree Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall AdaBoost Regression - Correlation: %s" %predR2ada, size = 20)
plt.savefig('figs/Fall AdaBoost Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Fall XGBoost Regression - Correlation: %s" %predR2xgb, size = 20)
plt.savefig('figs/Fall XGBoost Regression.png')
plt.show()
...
df3.hist(column='Fall Percent Different', grid=True, bins=50, range=[-100, 100])#xlabelsize=None, ylabelsize=None, figsize=None, 
