...
df2 = pd.read_csv('allMonsoon_delhi.csv')
...
plt.grid(b= True)
plt.title("Monsoon Linear Regression - Correlation: %s" %predR2ln, size = 20)
plt.savefig('figs/Monsoon Linear Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon KNN Regression - Correlation: %s" %predR2kn, size = 20)
plt.savefig('figs/Monsoon KNN Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon SVM Regression - Correlation: %s" %predR2svr, size = 20)
plt.savefig('figs/Monsoon SVM Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon Random Forests Regression - Correlation: %s" %predR2rf, size = 20)
plt.savefig('figs/Monsoon Random Forests Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon Decision Tree Regression - Correlation: %s" %predR2dt, size = 20)
plt.savefig('figs/Monsoon Decision Tree Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon AdaBoost Regression - Correlation: %s" %predR2ada, size = 20)
plt.savefig('figs/Monsoon AdaBoost Regression.png')
plt.show()
...
plt.ylabel('Predicted O3 Concentration (µg/m³)')
plt.grid(b= True)
plt.title("Monsoon XGBoost Regression - Correlation: %s" %predR2xgb, size = 20)
plt.savefig('figs/Monsoon XGBoost Regression.png')
plt.show()
...
df3.hist(column='Monsoon Percent Different', grid=True, bins=50, range=[-100, 100])#xlabelsize=None, ylabelsize=None, figsize=None, 
