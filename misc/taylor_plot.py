...
def test1():
    ...
    samples = [[26.129, NP.sqrt(0.784), "XGBoost"],
               [24.502, NP.sqrt(0.782), "Rand For"],
               [27.791, NP.sqrt(0.739), "KNN"],
               [22.921, NP.sqrt(0.695), "SVM"],
               [23.124, NP.sqrt(0.656), "Dec Tree"],
               [20.4, NP.sqrt(0.626), "Lin Regr"],
               [16.16, NP.sqrt(0.623), "Adaboost"]]
    ...
    for i, (stddev, corrcoef, lab) in enumerate(samples):
...
if __name__ == '__main__':
    ...
    dia = test1()
    PLT.savefig('plot_taylor1.pdf')
    #dia = test2()
    #PLT.savefig('plot_taylor2.png')
